...
public class Battle implements Serializable{
    ...
    public void attackTurn(Attack attack) {
        ...
        System.out.println("my attack: " + attack.getName());
        System.out.println("enemy health: " + enemy.getCurrentHp());
        if (checkBattleComplete()) {
            postBattle();
            return;
        }
        enemy.attack(myPokemon, enemy.getRandomAttack());
        System.out.println("enemy attack: " + enemy.getRandomAttack().getName());
        System.out.println("your pokemon health is now: " + myPokemon.getCurrentHp());
        if (checkBattleComplete()) {
            postBattle();
        }
    }
